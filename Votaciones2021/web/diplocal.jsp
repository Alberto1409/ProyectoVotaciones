<%-- 
    Document   : diplocal
    Created on : 1/06/2021, 08:15:37 PM
    Author     : Kinjiro
--%>
...
<html>
    ...
    <body>
        ...
        %>
        <form action = "http://localhost:8080/Votaciones2021/Diplocal" method="post">
            <center>
                <h1>DIPUTADO LOCAL</h1>
                <table BORDER ="1">
                    ...
                    <tr>
                        <td>INDEPENDIENTE:<br></td>
                    </tr>
                    <tr>
                        <td>LUIS ANGEL MORALES</td><td><input type="text" name="indep1" value="0"><br></td>
                    </tr>
                    <tr>
                ...
                <%
                    if (request.getAttribute("diplocal") != null) {
                ...
                %>
                <%
                    if (request.getAttribute("diplocalE") != null) {
                %>
                <table>
                    <tr>
                        <td>
